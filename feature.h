 ...
 *
 *
 *	    -after cloning vim repo from github...
 *	    -enable `#define WANT_X11` in vim/src/feature.h (this file)
 *	     to enable yank/paste to X clipboard
 *	    -then `sudo make && sudo make install` in vim/src directory...
 *
 * 
 */
/*
